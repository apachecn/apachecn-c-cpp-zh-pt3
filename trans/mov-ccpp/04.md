...
![image](images/sq.jpg) **注意**这太乏味了，变得不太可能。
...
![image](images/sq.jpg) **注**我们会在本书的过程中看到它们。
...
![image](images/sq.jpg) **注意**有些编译器还是允许你产生 C 代码的。
...
![image](images/sq.jpg) **注意**在你的电脑上你可能会得到不同的结果。
...
![image](images/sq.jpg) **注意**这是 C++的一个定义规则:你可以任意多次声明事物，但是每个事物只能有一个实际的定义。
