...
![A978-1-4842-1371-1_9_Figa_HTML.gif](A978-1-4842-1371-1_9_Figa_HTML.gif)
...
![A978-1-4842-1371-1_9_Figb_HTML.gif](A978-1-4842-1371-1_9_Figb_HTML.gif)
...
*   Interchange the numbers in positions `0` and `4`. We get this:
    ...
    ![A978-1-4842-1371-1_9_Figc_HTML.gif](A978-1-4842-1371-1_9_Figc_HTML.gif)
...
*   Interchange the numbers in positions `1` and `5`. We get this:
    ...
    ![A978-1-4842-1371-1_9_Figd_HTML.gif](A978-1-4842-1371-1_9_Figd_HTML.gif)
...
*   Interchange the numbers in positions `2` and `5`. We get this:
    ...
    ![A978-1-4842-1371-1_9_Fige_HTML.gif](A978-1-4842-1371-1_9_Fige_HTML.gif)
...
*   Interchange the numbers in positions `3` and `6`. We get this:
    ...
    ![A978-1-4842-1371-1_9_Figf_HTML.gif](A978-1-4842-1371-1_9_Figf_HTML.gif)
...
*   Interchange the numbers in positions `4` and `4`. We get this:
    ...
    ![A978-1-4842-1371-1_9_Figg_HTML.gif](A978-1-4842-1371-1_9_Figg_HTML.gif)
...
*   Interchange the numbers in positions `5` and `6`. We get this:
    ...
    ![A978-1-4842-1371-1_9_Figh_HTML.gif](A978-1-4842-1371-1_9_Figh_HTML.gif)
...
*   The 8th number, `0`, is read; it is `0` so we exit the `while` loop and the array looks like this:
    ...
    ![A978-1-4842-1371-1_9_Figi_HTML.gif](A978-1-4842-1371-1_9_Figi_HTML.gif)
...
我们说选择排序的顺序是 O(n <sup>2</sup> )(“大 on 的平方”)。常数在“大 O”符号中并不重要，因为当 n 变得很大时，常数变得无关紧要。

每一次，我们用三个任务交换两个项目。我们进行了 n-1 次传递，因此我们总共进行了 3(n-1)次分配。使用“大 O”符号，我们说赋值的个数是 O(n)。常数 3 和 1 并不重要，因为 n 变大了。
...
![A978-1-4842-1371-1_9_Figj_HTML.gif](A978-1-4842-1371-1_9_Figj_HTML.gif)
...
*   Process `num[1]`, that is, `48`. This involves placing `48` so that the first two numbers are sorted; `num[0]` and `num[1]` now contain the following:
    ...
    ![A978-1-4842-1371-1_9_Figk_HTML.gif](A978-1-4842-1371-1_9_Figk_HTML.gif)
...
*   Process `num[2]`, that is, `79`. This involves placing `79` so that the first three numbers are sorted; `num[0]` to `num[2]` now contain the following:
    ...
    ![A978-1-4842-1371-1_9_Figl_HTML.gif](A978-1-4842-1371-1_9_Figl_HTML.gif)
...
*   Process `num[3]`, that is, `65`. This involves placing `65` so that the first four numbers are sorted; `num[0] to num[3]` now contain the following:
    ...
    ![A978-1-4842-1371-1_9_Figm_HTML.gif](A978-1-4842-1371-1_9_Figm_HTML.gif)
...
*   Compare `33` with `15`; it is bigger, so insert `33` in location `1`. This gives the following:
    ...
    ![A978-1-4842-1371-1_9_Figt_HTML.gif](A978-1-4842-1371-1_9_Figt_HTML.gif)
...
*   Compare `52` with `48`; it is bigger, so insert `52` in location `3`. This gives the following:
    ...
    ![A978-1-4842-1371-1_9_Figu_HTML.gif](A978-1-4842-1371-1_9_Figu_HTML.gif)
...
![$$ {\displaystyle \sum_{j=2}^n\raisebox{1ex}{$1$}\!\left/ \!\raisebox{-1ex}{$2$}\right.}\left(j-1\right)=\raisebox{1ex}{$1$}\!\left/ \!\raisebox{-1ex}{$2$}\right.\left\{1+2+\cdots +n-1\right\}=\raisebox{1ex}{$1$}\!\left/ \!\raisebox{-1ex}{$4$}\right.n\left(n-1\right)\approx \raisebox{1ex}{$1$}\!\left/ \!\raisebox{-1ex}{$4$}\right.{n}^2 $$](A978-1-4842-1371-1_9_Chapter_TeX2GIF_Equa.gif)

我们说插入排序的阶数为 O(n <sup>2</sup> )(“大 on 的平方”)。随着`n`变大，常数并不重要。
...
![A978-1-4842-1371-1_9_Figv_HTML.gif](A978-1-4842-1371-1_9_Figv_HTML.gif)
...
![A978-1-4842-1371-1_9_Figw_HTML.gif](A978-1-4842-1371-1_9_Figw_HTML.gif)
