...
![A978-1-4842-0004-9_8_Fig1_HTML.gif](A978-1-4842-0004-9_8_Fig1_HTML.gif)
...
![A978-1-4842-0004-9_8_Fig2_HTML.gif](A978-1-4842-0004-9_8_Fig2_HTML.gif)
...
![A978-1-4842-0004-9_8_Fig3_HTML.gif](A978-1-4842-0004-9_8_Fig3_HTML.gif)
...
![A978-1-4842-0004-9_8_Fig4_HTML.gif](A978-1-4842-0004-9_8_Fig4_HTML.gif)
...
![$$ area=\frac{L}{2}\kern0.5em \underset{0}{\overset{p}{{\displaystyle \int }}} \sin q $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_Equa.gif)

sin θ的积分是![$$ \left(- \cos q\right) $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq1.gif)所以面积是![$$ \frac{L}{2}\left(\left(- \cos p\right)-\left(- \cos 0\right)\right) $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq2.gif)，计算得到![$$ \frac{L}{2}\left(1+1\right) $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq3.gif)，简单来说就是`L`！
...
![A978-1-4842-0004-9_8_Fig5_HTML.gif](A978-1-4842-0004-9_8_Fig5_HTML.gif)
...
![$$ \mu =\frac{{\displaystyle {\sum}_0^n}{x}_i}{n}\kern2em \sigma =\sqrt{\frac{{\displaystyle {\sum}_0^n}{\left({x}_i-\mu \right)}^2}{n-1}} $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_Equb.gif)
...
![A978-1-4842-0004-9_8_Fig6_HTML.gif](A978-1-4842-0004-9_8_Fig6_HTML.gif)
...
![A978-1-4842-0004-9_8_Fig7_HTML.gif](A978-1-4842-0004-9_8_Fig7_HTML.gif)
...
![A978-1-4842-0004-9_8_Fig8_HTML.gif](A978-1-4842-0004-9_8_Fig8_HTML.gif)
...
![$$ s={\displaystyle \sum}_0^{n-1}\left({v}_{i+1}-{v}_i\right)\frac{\left({w}_{i+1}+{w}_i\right)}{2} $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_Equc.gif)

其中 v <sub>i</sub> 是样本值，w <sub>i</sub> 是它们对应的权重。

两个样本值之间的区间中的任何值`x`的概率`p`，【v <sub>i</sub> ，![$$ {v}_{i+1} $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq4.gif)由样本值的概率的线性组合来确定，其中来自区间的每一端的概率贡献与 x 到样本值的距离成比例。用数学术语来说，x 的概率是:

![$$ p=\frac{w_i\left({v}_{i+1}-x\right)+{w}_{i+1}\left(x-{v}_i\right)}{s\left({v}_{i+1}-{v}_i\right)} $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_Equd.gif)
...
![A978-1-4842-0004-9_8_Fig9_HTML.gif](A978-1-4842-0004-9_8_Fig9_HTML.gif)
...
![A978-1-4842-0004-9_8_Fig10_HTML.gif](A978-1-4842-0004-9_8_Fig10_HTML.gif)
...
![A978-1-4842-0004-9_8_Fig11_HTML.gif](A978-1-4842-0004-9_8_Fig11_HTML.gif)
...
![A978-1-4842-0004-9_8_Fig12_HTML.gif](A978-1-4842-0004-9_8_Fig12_HTML.gif)
...
每个随机数 x <sub>n</sub> 用于生成下一个![$$ {x}_{n+1} $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq5.gif)，使用公式:

![$$ {x}_{n+1}=\left(a{x}_n+c\right)\kern0.5em\mod \kern0.5em m $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_Eque.gif)
...
`subtract_with_carry_engine`模板定义了一个随机数引擎，它实现了带进位的减法算法，这是对线性同余算法的改进。与线性同余法一样，带进位的减法算法使用递归关系来定义序列中的连续值，但是每个值 x <sub>i</sub> 都是从序列中两个较早的值![$$ {x}_{i-r} $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq6.gif)和![$$ {x}_{i-s} $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq7.gif)计算出来的，而不仅仅是前一个值。`r`和 s 分别称为长滞后和短滞后，且都必须为正，r 必须大于`s`。产生该序列的方程式是:

![$$ {D}_i=\left({x}_{i-r}-{x}_{i-s}-{c}_{i-1}\right)\kern0.5em\mod \kern0.5em m $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq8.gif)其中`m`为`2`<sup>`n`</sup>`n`为一个字的位数。

![$$ {x}_i={D}_i $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq9.gif)和![$$ {c}_n=0 $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq10.gif)如果![$$ {D}_i{}^30 $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq11.gif)

![$$ {x}_i=m+{D}_i $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq12.gif)和![$$ {c}_n=1 $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq13.gif)如果![$$ {D}_i<0 $$](A978-1-4842-0004-9_8_Chapter_TeX2GIF_IEq14.gif)
